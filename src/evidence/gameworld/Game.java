...
public Game(){
	...
	private ArrayList<Door> setupDoors() {
		...
		Door door = new Door("Door", "Door between the lounge and the bedroom", new ArrayList<>(Arrays.asList("inspect", "unlock")), getRoom(Name.LOUNGE), getRoom(Name.BEDROOM), true, 1, false);
		door.setCurrentImage("bigdoor.png");
		door.setXPos(60);
		door.setYPos(230);
		doors.add(door);

		door = new Door("Door", "Door between the lounge and the kitchen", new ArrayList<>(Arrays.asList("inspect", "enter", "lock")), getRoom(Name.LOUNGE), getRoom(Name.KITCHEN), false, 2, false);
		door.setCurrentImage("bigdoor.png");
		door.setXPos(60);
		door.setYPos(230);
		doors.add(door);

		door = new Door("Door", "Door between the bathroom and the bedroom", new ArrayList<>(Arrays.asList("inspect", "enter", "lock")), getRoom(Name.BATHROOM),	getRoom(Name.BEDROOM), false, 3, false);
		door.setCurrentImage("bigdoor.png");
		door.setXPos(60);
		door.setYPos(230);
		doors.add(door);

		door = new Door("Door", "Door between the office and the bedroom", new ArrayList<>(Arrays.asList("inspect", "enter", "lock")), getRoom(Name.OFFICE),	getRoom(Name.BEDROOM), false, 4, false);
		door.setCurrentImage("bigdoor.png");
		door.setXPos(260);
		door.setYPos(230);
		doors.add(door);
		
		door = new Door("Door", "Door between the office and the kitchen", new ArrayList<>(Arrays.asList("inspect", "enter", "lock")), getRoom(Name.OFFICE),	getRoom(Name.KITCHEN), false, 5, false);
		door.setCurrentImage("bigdoor.png");
		door.setXPos(460);
		door.setYPos(230);
		doors.add(door);
		
		door = new Door("Door", "Door between the garage and the kitchen", new ArrayList<>(Arrays.asList("inspect", "enter", "lock")), getRoom(Name.GARAGE),	getRoom(Name.KITCHEN), false, 6, false);
		door.setCurrentImage("bigdoor.png");
		door.setXPos(60);
		door.setYPos(230);
		doors.add(door);
	...
	private void setupBathroom(ArrayList<Door> doors){
		...
		// Bathroom North Wall
		MovableItem mop = new MovableItem("Mop", "A mop. This mop can be used for cleaning up and concealing evidence", new ArrayList<>(Arrays.asList("inspect", "pickup")), 3, false);
		mop.setCurrentImage("mop.png");
		mop.setXPos(160);
		mop.setYPos(490);
		getRoom(Name.BATHROOM).getWalls()[0].addItem(mop);

		Container bucket = new Container("Bucket", "A bucket. Things can be hidden in here", new ArrayList<>(Arrays.asList("inspect", "placeitem")), false, 2, false);
		...
		// Bathroom East Wall
		Container bath = new Container("Bath", "A bath tub. Things can be hidden in here", new ArrayList<>(Arrays.asList("inspect", "placeitem", "fill")), false, 6, false);
		...
		//South Wall
		Container toilet = new Container("Toilet", "A toilet. This toilet can be flushed", new ArrayList<>(Arrays.asList("inspect", "flush", "placeitem")), false, 2, false);
		toilet.setCurrentImage("toilet.png");
		toilet.setXPos(450);
		toilet.setYPos(500);
		getRoom(Name.BATHROOM).getWalls()[2].addItem(toilet);

		Container trashCan = new Container("Trash Can", "A trash can. You can kick this trash can over if you are feeling frustrated", new ArrayList<>(Arrays.asList("inspect", "kick", "placeitem")), false, 5, false);
		...
		Container sink = new Container("Sink", "A sink. Go ahead and wash your hands here. \nIt just might conceal some evidence", new ArrayList<>(Arrays.asList("inspect", "placeitem")), false, 1, false);
	...
	private void setupBedroom(ArrayList<Door> doors) {
		...
		// Bedroom North Wall
		Container bed = new Container("Bed", "A bed. You may take a nap here, or you could hide something underneath this bed.", new ArrayList<>(Arrays.asList("inspect", "placeitem")), false, 6, false);
		...
		Furniture bedsideTable = new Furniture("Bedside Table", "A bedside table that doesn't do much", new ArrayList<>(Arrays.asList("inspect")), false);
		...
		// Bedroom East Wall
		Container cupboard = new Container("Cupboard", "A Cupboard. This cupboard is quite large and can hide many things", new ArrayList<>(Arrays.asList("inspect", "unlock")), true, 7, false);
	...
	private void setupKitchen(ArrayList<Door> doors) {
		...
		Furniture stool = new Furniture("Stool", "A stool. Take a seat and strech your legs", new ArrayList<>(Arrays.asList("inspect")), false);
		stool.setCurrentImage("stool.png");
		stool.setXPos(300);
		stool.setYPos(400);
		getRoom(Name.KITCHEN).getWalls()[0].addItem(stool);

		Furniture stoolOne = new Furniture("Stool", "A stool. Only lift this stool once!", new ArrayList<>(Arrays.asList("inspect")), false);
		...
		Container fridge = new Container("Fridge", "A Fridge", new ArrayList<>(Arrays.asList("inspect", "placeitem")), false, 5, false);
		...
		// Kitchen South Wall
		Container oven = new Container("Oven", "An oven", new ArrayList<>(Arrays.asList("inspect", "placeitem")), false, 3, false);
		oven.setCurrentImage("oven.png");
		oven.setXPos(0);
		oven.setYPos(0);
		getRoom(Name.KITCHEN).getWalls()[2].addItem(oven);

		MovableItem gloves = new MovableItem("Gloves", "Rubber gloves", new ArrayList<>(Arrays.asList("inspect", "pickup")), 1, false);
		gloves.setCurrentImage("gloves.png");
		gloves.setXPos(0);
		gloves.setYPos(0);

		MovableItem bleach = new MovableItem("Bleach", "Kitchen Bleach", new ArrayList<>(Arrays.asList("Inspect", "pickup")), 2, false);
		...
		Container cabnet = new Container("Cabnet", "A cabnet", new ArrayList<>(Arrays.asList("inspect", "placeitem", "remove " + gloves.toString(), "remove " + bleach.toString())), false, 3, false);
		...
		MovableItem scissors = new MovableItem("Scissors", "A pair of Kitchen scissors", new ArrayList<>(Arrays.asList("inspect", "pickup")), 1, false);
	...
	private void setupGarage(ArrayList<Door> doors) {
		...
		// Garage South Wall
		MovableItem axe = new MovableItem("Axe", "An Axe. HINT - clean this to conceal evidence", new ArrayList<>(Arrays.asList("inspect", "pickup")), 3, false);
		axe.setCurrentImage("baxe.png");
		axe.setXPos(200);
		axe.setYPos(200);
		getRoom(Name.GARAGE).getWalls()[2].addItem(axe);

		MovableItem sledgeHammer = new MovableItem("Sledge Hammer", "A Sledge Hammer. Try not to get your finger prints on this. \n HINT gloves are in the kitchen cupboard", new ArrayList<>(Arrays.asList("inspect", "pickup")), 3, false);
		...
		Container cbBox = new Container("CardboardBox", "A cardboard box. Nice and roomy. Lots of space to hide bloody clothes. \n maybe the police will think its a costume box...", new ArrayList<>(Arrays.asList("inspect", "placeitem")), false, 4, false);
		cbBox.setCurrentImage("cbbox.png");
		cbBox.setXPos(300);
		cbBox.setYPos(300);
		getRoom(Name.GARAGE).getWalls()[2].addItem(cbBox);
		
		Evidence clothes = new Evidence("Bloodied Clothing", "Bloody clothes. The police probably wont like seeing this", new ArrayList<>(Arrays.asList("inspect")), 4, false);
		...
		MovableItem saw = new MovableItem("Saw", "A saw", new ArrayList<>(Arrays.asList("inspect", "pickup")), 3, false);
		...
		MovableItem screwdriver = new MovableItem("Screw Driver", "A screw driver", new ArrayList<>(Arrays.asList("remove")), 1, false);
		screwdriver.setCurrentImage("screwdriver.png");
		screwdriver.setXPos(0);
		screwdriver.setYPos(0);

		Container toolbox = new Container("Tool Box", "A tool Box", new ArrayList<>(Arrays.asList("inspect", "placeitem", "remove " + wrench.toString(), "remove " + hammer.toString(), "remove " + screwdriver.toString())), false, 7, false);
	...
	private void setupLounge(ArrayList<Door> doors) {
		...
		// Lounge North Wall
		Furniture fireplace = new Furniture("Fireplace", "A Fireplace", new ArrayList<>(Arrays.asList("inspect", "light")), false);
		...
		Furniture coffeeTable = new Furniture("Coffee Table", "A coffee table", new ArrayList<>(Arrays.asList("inspect")), false);
	...
	private void setupOffice(ArrayList<Door> doors) {
		...
		Furniture potplant = new Furniture("Pot Plant", "A pot plant", new ArrayList<>(Arrays.asList("inspect")), false);
		...
		// Office East Wall
		Evidence body = new Evidence("Body", "Victim's Body", new ArrayList<>(Arrays.asList("inspect", "cutup")), 20, true);
		body.setCurrentImage("body.png");
		body.setXPos(100);
		body.setYPos(400);
		getRoom(Name.OFFICE).getWalls()[1].addItem(body);

		MovableItem knife = new MovableItem("Knife", "A kitchen kinfe", new ArrayList<>(Arrays.asList("inspect", "pickup", "clean")), 2, true);
		...
		// Office South Wall
		Evidence camera = new Evidence("Camera", "A security camera", new ArrayList<>(Arrays.asList("inspect")), 20, false);
		camera.setCurrentImage("cameraon.png");
		camera.setXPos(550);
		camera.setYPos(30);
		getRoom(Name.OFFICE).getWalls()[2].addItem(camera);

		Container safe = new Container("Safe", "A safe", new ArrayList<>(Arrays.asList("inspect", "unlock")), true, 6, false);
